...
@Component({
  selector: 'app-index-not-auth',
  templateUrl: './index-not-auth.component.html',
  styleUrls: ['./index-not-auth.component.css']
})
export class IndexNotAuthComponent implements OnInit {
